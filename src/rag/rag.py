...
def update_db(
    data_dir="./data", db_dir="./chroma_db", filelist_path="./data/filelist.txt"
):
    ...
    if os.path.exists(filelist_path):
        ...
        if current_files == saved_files:
            ...
            print("data files have been changed,removing old db")
...
def generate_prompt(
    context: str, query: str, system_prompt: str = "You are a helpful assistant."
) -> str:
    prompt = f"""<|system|>
{system_prompt}
<|user|>
...
def run(query: str, system_prompt: str = "You are a helpful assistant.") -> str:
    # Load text
    ...
    return generate_prompt(context, query, system_prompt)
